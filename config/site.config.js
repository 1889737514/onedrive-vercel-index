...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'sz2110@yattaze.onmicrosoft.com',
  ...
  googleFontLinks: ['https://fonts.google.com/css2?family=Fira+Mono&family=Inter:wght@400;500;700&display=swap'],
